...
import com.optum.aog.config.Constants;
import com.optum.aog.dto.*;
import com.optum.aog.exception.*;
import com.optum.aog.factory.RestResponseHeaderFactory;
import com.optum.aog.jpa.domain.Attachment;
import com.optum.aog.parser.Export;
import com.optum.aog.service.DBPullService;
...
/**
 * Rest controller to perform CRUD operations on an AOG
...
public class PullAOGController extends RestResponseHeaderFactory {
    ...
    public ResponseEntity<?> getHome() {
        return renderResponseEntity("Welcome to the AOG");
    }
    ...
    public ResponseEntity<?> getAOGList() {
        LOGGER.info("[PullAOGController] - Getting AOG List");
    ...
    /**
     * <p>A GET method that returns the requested AOG</p>
     *
     * @param id The id of an AOG to return
     * @return if successful, the method will return {@link HttpStatus#OK} ,
     * or will return {@link HttpStatus#NO_CONTENT} if no aog was found
     * or will return {@link HttpStatus#INTERNAL_SERVER_ERROR} if any exception was thrown in dbPullService
     */
    ...
    public ResponseEntity<?> getAOG(@Param("id") Long id) {
        LOGGER.info(String.format("[PullAOGController] - Getting AOG with id = %d", id));
    ...
    /**
     * <p>A POST method that creates/adds AOG to in memory cache</p>
     *
     * @param id The id of the AOG to instantiate
    ...
    public ResponseEntity<?> instantiateAOG(@RequestParam("id") Long id) {
        LOGGER.info(String.format("[PullAOGController] - Instantiating Cache for AOG with id = %d", id));
    ...
    /**
     * <p>A POST method, Returns the results of the search on an AOG. It only returns the chapters
    ...
    public ResponseEntity<?> searchAOG(@RequestBody SearchInput payload) {
        LOGGER.info(String.format("[PullAOGController] - Searching Entire AOG with these arguments, searchTerm = %s, aogId = %d", payload.getSearchTerm(), payload.getPlatform()));
     ...
     *                along with a search term and AOG id.
    ...
    public ResponseEntity<?> searchChapterAOG(@RequestBody SearchChapterInput payload) {
        LOGGER.info(String.format("[PullAOGController] - Searching Specific chapters of AOG searchTerm = %s, aogId=%d, chapters=%s ",
     ...
     * @return Updated AOG with {@link HttpStatus#OK}
    ...
    public FileSystemResource exportCategories(@RequestBody CategoryDTO payload,
                                               HttpServletResponse response) throws IOException {
        LOGGER.info(String.format("[PullAOGController] - Exporting AOG Categories Document "));
    ...
    public FileSystemResource exportSubChapters(@RequestBody SubChapterDTO payload,
                                               HttpServletResponse response) throws IOException {
        LOGGER.info(String.format("[PullAOGController] - Exporting AOG SubChapters Document "));
    ...
    public FileSystemResource exportChapters(@RequestBody ChapterDTO payload,
                                                HttpServletResponse response) throws IOException {
        LOGGER.info(String.format("[PullAOGController] - Exporting AOG Chapters Document "));
    ...
    /**
     * <p>Endpoint to get a list of all chapters in an AOG</p>
     *
     * @param id the id of the AOG that contains the chapters
    ...
    /**
     * End point to remove a Chapter/SubChapter/Category from the AOG
     *
    ...
    /**
     * End point to add a Chapter/SubChapter/Category to the AOG
     *
